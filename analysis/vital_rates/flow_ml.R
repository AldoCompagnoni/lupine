...
climate_mods <- list(
  ...
  # precipitation
  flow_t1 ~ log_area_t1 + log_area_t12 + ppt_t0 + (log_area_t1 | year) + (log_area_t1 | location),
  flow_t1 ~ log_area_t1 + log_area_t12 + ppt_tm1 + (log_area_t1 | year) + (log_area_t1 | location),
  flow_t1 ~ log_area_t1 + log_area_t12 + ppt_t0_tm1 + (log_area_t1 | year) + (log_area_t1 | location),
  flow_t1 ~ log_area_t1 + log_area_t12 + ppt_t0_tm2 + (log_area_t1 | year) + (log_area_t1 | location),
  
  # temperature
  flow_t1 ~ log_area_t1 + log_area_t12 + tmp_t0 + (log_area_t1 | year) + (log_area_t1 | location),
  flow_t1 ~ log_area_t1 + log_area_t12 + tmp_tm1 + (log_area_t1 | year) + (log_area_t1 | location),
  flow_t1 ~ log_area_t1 + log_area_t12 + tmp_t0_tm1 + (log_area_t1 | year) + (log_area_t1 | location),
  flow_t1 ~ log_area_t1 + log_area_t12 + tmp_t0_tm2 + (log_area_t1 | year) + (log_area_t1 | location),
  
  # enso
  flow_t1 ~ log_area_t1 + log_area_t12 + oni_t0 + (log_area_t1 | year) + (log_area_t1 | location)+ (1 | newid),
  flow_t1 ~ log_area_t1 + log_area_t12 + oni_tm1 + (log_area_t1 | year) + (log_area_t1 | location),
  flow_t1 ~ log_area_t1 + log_area_t12 + oni_t0_tm1 + (log_area_t1 | year) + (log_area_t1 | location),
  flow_t1 ~ log_area_t1 + log_area_t12 + oni_t0_tm2 + (log_area_t1 | year) + (log_area_t1 | location)
  
  # spei
  flow_t1 ~ log_area_t1 + log_area_t12 + spei_t0 + (log_area_t1 | year) + (log_area_t1 | location)+ (1 | newid),
  flow_t1 ~ log_area_t1 + log_area_t12 + spei_tm1 + (log_area_t1 | year) + (log_area_t1 | location),
  flow_t1 ~ log_area_t1 + log_area_t12 + spei_t0_tm1 + (log_area_t1 | year) + (log_area_t1 | location),
  flow_t1 ~ log_area_t1 + log_area_t12 + spei_t0_tm2 + (log_area_t1 | year) + (log_area_t1 | location)
