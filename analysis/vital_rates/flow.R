...
mod1 <- glmer(flow_t1 ~ log_area_t1 + avgt0 + (1 | year), data= flow_df, 
              family = binomial )
mod2 <- glmer(flow_t1 ~ log_area_t1 + avgtm1 + (1 | year), data= flow_df, 
              family = binomial )
mod3 <- glmer(flow_t1 ~ log_area_t1 + avgtm2 + (1 | year), data= flow_df, 
              family = binomial )

# write it out
bind_rows( fixef(mod1),fixef(mod2), fixef(mod3) ) %>% 
  write.csv(paste0('results/lme4/','flow_',clim_var,'.csv'),row.names=F)
...
# 
# write.csv(out_summ, paste0('results/flow_a_summ_',clim_var,'.csv'),row.names=F)
# write.csv(out_post, paste0("results/flow_a_post_",clim_var,".csv"),row.names=F)
# 
# 
...
# 
# write.csv(out_summ, paste0("results/flow_sam_3y_summ_",clim_var,".csv"),row.names=F)
# write.csv(out_post, paste0("results/flow_sam_3y_post_",clim_var,".csv"),row.names=F)
...
write.csv(out_summ, paste0('results/flow_a_summ_re_',clim_var,'.csv'))
write.csv(out_post, paste0("results/flow_a_post_re_",clim_var,".csv"),row.names=F)
...
write.csv(out_summ, paste0("results/flow_sam_3y_summ_re_",clim_var,".csv"))
write.csv(out_post, paste0("results/flow_sam_3y_post_re_",clim_var,".csv"),row.names=F)
...
# 
# write.csv(out_summ, paste0("results/flow_sam_12m_summ_",clim_var,".csv"))
# write.csv(out_post, paste0("results/flow_sam_12m_post_",clim_var,".csv"),row.names=F)
