...
climate_mods <- list(
  ...
  # precipitation
  numrac_t1 ~ log_area_t1 + log_area_t12 + ppt_t0 + (log_area_t1 | year) + (log_area_t1 | location),
  numrac_t1 ~ log_area_t1 + log_area_t12 + ppt_tm1 + (log_area_t1 | year) + (log_area_t1 | location),
  numrac_t1 ~ log_area_t1 + log_area_t12 + ppt_t0_tm1 + (log_area_t1 | year) + (log_area_t1 | location),
  numrac_t1 ~ log_area_t1 + log_area_t12 + ppt_t0_tm2 + (log_area_t1 | year) + (log_area_t1 | location),
  
  # temperature
  numrac_t1 ~ log_area_t1 + log_area_t12 + tmp_t0 + (log_area_t1 | year) + (log_area_t1 | location),
  numrac_t1 ~ log_area_t1 + log_area_t12 + tmp_tm1 + (log_area_t1 | year) + (log_area_t1 | location),
  numrac_t1 ~ log_area_t1 + log_area_t12 + tmp_t0_tm1 + (log_area_t1 | year) + (log_area_t1 | location),
  numrac_t1 ~ log_area_t1 + log_area_t12 + tmp_t0_tm2 + (log_area_t1 | year) + (log_area_t1 | location),
