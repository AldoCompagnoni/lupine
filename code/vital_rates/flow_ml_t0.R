...
climate_mods <- list(
  ...
  flow_t0 ~ log_area_t0 + log_area_t02 + ppt_t0_tm1 + (log_area_t0 | year) + (log_area_t0 | location),
  flow_t0 ~ log_area_t0 + log_area_t02 + ppt_t0_tm2 + (log_area_t0 | year) + (log_area_t0 | location),
  ...
  flow_t0 ~ log_area_t0 + log_area_t02 + tmp_t0_tm1 + (log_area_t0 | year) + (log_area_t0 | location),
  flow_t0 ~ log_area_t0 + log_area_t02 + tmp_t0_tm2 + (log_area_t0 | year) + (log_area_t0 | location),
  
  # enso
  flow_t0 ~ log_area_t0 + log_area_t02 + oni_t0 + (log_area_t0 | year) + (log_area_t0 | location)+ (1 | newid),
  flow_t0 ~ log_area_t0 + log_area_t02 + oni_tm1 + (log_area_t0 | year) + (log_area_t0 | location),
  flow_t0 ~ log_area_t0 + log_area_t02 + oni_t0_tm1 + (log_area_t0 | year) + (log_area_t0 | location),
  flow_t0 ~ log_area_t0 + log_area_t02 + oni_t0_tm2 + (log_area_t0 | year) + (log_area_t0 | location)
